...
curl --verbose  --user "schuettec:${BINTRAY_API_KEY}" --request "POST" "https://api.bintray.com/maven_central_sync/schuettec/maven/com.github.schuettec:jbeanviews/versions/${version}"
