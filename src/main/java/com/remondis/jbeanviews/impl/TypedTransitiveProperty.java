...
import static com.remondis.jbeanviews.impl.BeanViewException.accessError;
...
import com.remondis.jbeanviews.impl.BeanViewException.NotAValidPropertyPathException;
 ...
 * @param <T>
 */
class TypedTransitiveProperty<T, R> {
  ...
  public R get(T rootTargetInstance) throws RuntimeException {
    try {
  ...
  public static <T, R> TypedTransitiveProperty<T, R> of(Class<T> sensorType, R returnValue,
    ...
    return new TypedTransitiveProperty<T, R>(sensorType, returnValue, trackedInvocations);
  }
