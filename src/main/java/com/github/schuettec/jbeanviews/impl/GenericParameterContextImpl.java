 ...
 */
public class GenericParameterContextImpl implements GenericParameterContext {
   ...
   */
  private GenericParameterContextImpl(Method method) {
    super();
    this.method = method;
    init();
  }

  public static GenericParameterContext ofMethod(Method method) {
    return new GenericParameterContextImpl(method);
  }

  public static GenericParameterContext ofNonGeneric(Class<?> type) {
    return new GenericParameterContext() {
      ...
      public ParameterizedType get() {
        throw new UnsupportedOperationException("Cannot provide parameterized type. This type is not generic.");
      }
    };
  }

  GenericParameterContextImpl(Stack<ParameterizedType> stack, boolean finished, Class<?> currentType, Method method) {
    super();
    this.stack = stack;
  ...
  public GenericParameterContext goInto(int genericParameterIndex) {
    ...
    GenericParameterContextImpl newCtx = new GenericParameterContextImpl(newStack, finished, currentType, method);
